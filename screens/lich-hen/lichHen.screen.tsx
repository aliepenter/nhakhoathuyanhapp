                ...
                {!loading
                    ...
                    chinhNha && chinhNha.length != 0
                        ...
                        chinhNha.map((item: ChinhNha, index: number) => {
                            const isLast = index === chinhNha.length - 1;
                        
                            return (
                                <Pressable
                                    key={index}
                                    className={`flex-row items-center h-20 ${isLast ? 'mb-28' : ''}`}
                                ...
                                >
                                    <View className='items-center justify-center h-full py-[10px] w-[20%] border-r-[1px] border-[#D8D8D8]'>
                                        ...
                                        <Image
                                            source={checkActive(item.ngay_chinh_nha, index) ? icons.circleActive : icons.circle}
                                            resizeMode='cover'
                                            className={`${Platform.OS === 'ios' ? 'top-[56%]' : 'top-[60%]'} w-[13px] h-[13px] absolute right-[-6.5px]`}
                                        />
                                    </View>
